    ...
    public partial class Initialmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Applications_CourseDates_CourseDateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationParticipants", x => new { x.ApplicationId, x.ParticipantId });
                    table.ForeignKey(
                        name: "FK_ApplicationParticipants_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "ApplicationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationParticipants_Participants_ParticipantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationParticipants_ParticipantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_CourseDateId",
                table: "Applications",
                column: "CourseDateId");
